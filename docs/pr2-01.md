...
- special tokens (exactly these 4, no more):  
  `<|ngpt_sys_84a5023f67d74cf29cc4001becde983c|>`, `<|ngpt_usr_84a5023f67d74cf29cc4001becde983c|>`, `<|ngpt_asst_84a5023f67d74cf29cc4001becde983c|>`, `<|ngpt_eot_84a5023f67d74cf29cc4001becde983c|>`
- stop condition (future generation): **stop only on `<|ngpt_eot_84a5023f67d74cf29cc4001becde983c|>` token id**
...
- `artifacts/tokenizer/v2/spm.model`
- `artifacts/tokenizer/v2/tokenizer_meta.json`
...
SPECIAL_TOKENS = (
    "<|ngpt_sys_84a5023f67d74cf29cc4001becde983c|>",
    "<|ngpt_usr_84a5023f67d74cf29cc4001becde983c|>",
    "<|ngpt_asst_84a5023f67d74cf29cc4001becde983c|>",
    "<|ngpt_eot_84a5023f67d74cf29cc4001becde983c|>",
)
...
template (exact structure):
	...
	•	<|ngpt_sys_84a5023f67d74cf29cc4001becde983c|> {content} <|ngpt_eot_84a5023f67d74cf29cc4001becde983c|> for system
	•	<|ngpt_usr_84a5023f67d74cf29cc4001becde983c|> {content} <|ngpt_eot_84a5023f67d74cf29cc4001becde983c|> for user
	•	<|ngpt_asst_84a5023f67d74cf29cc4001becde983c|> {content} <|ngpt_eot_84a5023f67d74cf29cc4001becde983c|> for assistant
...
def format_prompt(
    ...
    - appends the assistant sentinel only at the end (no EOT) so the model continues as assistant
    """
...
def extract_assistant_reply(
    ...
    - tokens after the final assistant token
    - up to (but not including) the first EOT after that
    - if no EOT exists, return tokens to end
    """

hard invariants:
	•	format_prompt(...) ends with the assistant id
	•	extract_assistant_reply never returns tokens before the last assistant token
...
flags (exact):
	•	--out_dir (default artifacts/tokenizer/v2)
...
tests/test_chat_template.py
	...
	•	format_prompt ends with assistant token and no trailing EOT
	•	extract_assistant_reply slices correctly given a synthetic generated sequence:
prompt + assistant token + “hello” + EOT + junk
